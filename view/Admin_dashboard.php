...
<body>
    <nav class="navbar">
        ...
        <ul>
            <li><a href="../function/users.php">Users</a></li>
            <li><a href="../function/buy_Coconuts.php">Available coconuts</a></li>
            <li><a href="../view/regular_dashboard.php">User Admin_dashboard</a></li>
